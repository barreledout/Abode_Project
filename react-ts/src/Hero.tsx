  ...
  return (
    ...
    >
      ...
      <div className="max-w-[400px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2">
        <h2 className=" text-white text-center contrast-100 font-jost font-[700] text-[1.1rem] text-pretty text-sm leading-normal mq400w:text-nowrap mq400w:text-[1.2em] mq500w:text-[1.3em] sm:text-[1.5em] sm:leading-9 md:leading-10 md:text-[2em] 2xl:text-5xl">
